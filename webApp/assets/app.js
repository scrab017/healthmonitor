...
var dropDownCondition = {
    "bmi" : "BMI",
    "hemoglobin": "Hemoglobin (only Females)",
    "glucose" : "Glucose",
    "bp" : "Blood Pressure",
    "cbp" : "Cuff BP",
    "cancer" : "Cancer",
...
$(".NFHS_CONDITION_DROPDOWN_SELECT").on('click',function(){
    ...
    //$("#distributed_by_head").show();
    //$("#distributed_by_list").show();
...
$(".NFHS_DISEASE_DROPDOWN_SELECT").on('click',function(){
    ...
    //The distributed by selection should not be there in disease selection only
    //$("#distributed_by_head").hide();
    //$("#distributed_by_list").hide();
...
$(".MAGNITUDE_HEADER").on('click',function(){
            console.log("Div click identified ")
        ...
        function callReady(){
            ...
            if( PlotCategory[categoryCall].plotType == "nfhs_percent" ){
                if( dataTYPE != "" && dataTYPENation != "" && dataINCOME != "" && dataINCOMENation != "" && STATEDistrictTopo!=null){
                     ...
                     /*if(nfhsDiseaseIdetifier == "CONDITION" &&  stateNameCall == "India_state"){
                         console.log(" plot the state map for the condition !! ");
                         console.log("DataType : " ,dataTYPE);
                         console.log("DataIncome : ",dataTYPENation);
                         console.log("DataTypeNation : ",dataINCOME);
                         console.log("DataIncomeNation : ",dataINCOMENation);
                     }else*/
                     {
                         if(canvas) canvas.remove();
